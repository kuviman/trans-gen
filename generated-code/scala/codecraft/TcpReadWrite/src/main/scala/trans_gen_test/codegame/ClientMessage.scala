...
object ClientMessage {
     ...
     */
    case class DebugMessage(command: trans_gen_test.codegame.DebugCommand) extends ClientMessage {
        /**
    ...
    object DebugMessage {
        ...
        def readFrom(stream: java.io.InputStream): DebugMessage = DebugMessage(
            trans_gen_test.codegame.DebugCommand.readFrom(stream)
        )
    }
     ...
     */
    case class ActionMessage(action: trans_gen_test.model.Action) extends ClientMessage {
        /**
    ...
    object ActionMessage {
        ...
        def readFrom(stream: java.io.InputStream): ActionMessage = ActionMessage(
            trans_gen_test.model.Action.readFrom(stream)
        )
    }
