...
object DebugCommand {
     ...
     */
    case class Add(debugData: trans_gen_test.model.debug_interface.DebugData) extends DebugCommand {
        /**
    ...
    object Add {
        ...
        def readFrom(stream: java.io.InputStream): Add = Add(
            trans_gen_test.model.debug_interface.DebugData.readFrom(stream)
        )
    }
