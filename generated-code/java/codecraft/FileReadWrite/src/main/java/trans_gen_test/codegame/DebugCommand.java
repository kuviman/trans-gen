...
public abstract class DebugCommand {
    ...
    public static class Add extends DebugCommand {
         ...
         * Data to add
         */
        private trans_gen_test.model.debug_interface.DebugData debugData;
    
        /**
         * Data to add
         */
        public trans_gen_test.model.debug_interface.DebugData getDebugData() {
            return debugData;
        }
         ...
         * Data to add
         */
        public void setDebugData(trans_gen_test.model.debug_interface.DebugData value) {
            this.debugData = value;
        }
    
        public Add(trans_gen_test.model.debug_interface.DebugData debugData) {
        ...
        public static Add readFrom(java.io.InputStream stream) throws java.io.IOException {
            trans_gen_test.model.debug_interface.DebugData debugData;
            debugData = trans_gen_test.model.debug_interface.DebugData.readFrom(stream);
