...
public abstract class ServerMessage {
    ...
    public static class GetAction extends ServerMessage {
         ...
         * Player's view
         */
        private trans_gen_test.model.PlayerView playerView;
    
        /**
         * Player's view
         */
        public trans_gen_test.model.PlayerView getPlayerView() {
            return playerView;
        }
         ...
         * Player's view
         */
        public void setPlayerView(trans_gen_test.model.PlayerView value) {
        ...
        public GetAction(trans_gen_test.model.PlayerView playerView, boolean debugAvailable) {
        ...
        public static GetAction readFrom(java.io.InputStream stream) throws java.io.IOException {
            trans_gen_test.model.PlayerView playerView;
    ...
    public static class DebugUpdate extends ServerMessage {
        ...
        public DebugUpdate(trans_gen_test.model.PlayerView playerView) {
            this.playerView = playerView;
        }
