namespace TransGenTest.Codegame
{
    ...
    public abstract class DebugCommand
    {
        ...
        public class Add : DebugCommand
        {
            ...
            /// Data to add
            /// </summary>
            public Model.DebugInterface.DebugData DebugData { get; set; }
        
            public Add() { }
        
            public Add(Model.DebugInterface.DebugData debugData)
            {
            ...
            {
                var result = new Add();
                result.DebugData = Model.DebugInterface.DebugData.ReadFrom(reader);
                return result;
            }
