namespace TransGenTest
{
    ...
    public struct Example
    {
        ...
        /// Dictionary
        /// </summary>
        public System.Collections.Generic.IDictionary<Enumeration, int> HashMap { get; set; }
        /// <summary>
        /// Optional int
        /// </summary>
        ...
        /// Optional OneOf
        /// </summary>
        public OneOf OptionalOneOf { get; set; }
        /// <summary>
        /// Optional struct
        /// </summary>
        public Structure? OptionalStruct { get; set; }
        /// <summary>
        /// Optional enum
        /// </summary>
        public Enumeration? OptionalEnum { get; set; }
    
        public Example(OneOf oneOf, System.Collections.Generic.IDictionary<Enumeration, int> hashMap, int? optionalInt, bool? optionalBool, OneOf optionalOneOf, Structure? optionalStruct, Enumeration? optionalEnum)
        {
            this.OneOf = oneOf;
        ...
        public static Example ReadFrom(System.IO.BinaryReader reader)
        {
            ...
            result.OneOf = OneOf.ReadFrom(reader);
            int hashMapSize = reader.ReadInt32();
            result.HashMap = new System.Collections.Generic.Dictionary<Enumeration, int>(hashMapSize);
            ...
            if (reader.ReadBoolean())
            {
                result.OptionalOneOf = OneOf.ReadFrom(reader);
            } else
            {
            ...
            if (reader.ReadBoolean())
            {
                result.OptionalStruct = Structure.ReadFrom(reader);
            } else
            {
