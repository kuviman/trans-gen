...
ServerMessage::GetAction::GetAction(model::PlayerView playerView, bool debugAvailable) : playerView(playerView), debugAvailable(debugAvailable) { }

// Read GetAction from input stream
ServerMessage::GetAction ServerMessage::GetAction::readFrom(InputStream& stream) {
    model::PlayerView playerView = model::PlayerView::readFrom(stream);
...
ServerMessage::DebugUpdate::DebugUpdate(model::PlayerView playerView) : playerView(playerView) { }
