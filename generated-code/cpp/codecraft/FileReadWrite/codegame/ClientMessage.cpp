...
ClientMessage::DebugMessage::DebugMessage(std::shared_ptr<codegame::DebugCommand> command) : command(command) { }

// Read DebugMessage from input stream
ClientMessage::DebugMessage ClientMessage::DebugMessage::readFrom(InputStream& stream) {
    std::shared_ptr<codegame::DebugCommand> command = codegame::DebugCommand::readFrom(stream);
