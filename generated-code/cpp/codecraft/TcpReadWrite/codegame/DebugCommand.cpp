...
DebugCommand::Add::Add(std::shared_ptr<model::debug_interface::DebugData> debugData) : debugData(debugData) { }

// Read Add from input stream
DebugCommand::Add DebugCommand::Add::readFrom(InputStream& stream) {
    std::shared_ptr<model::debug_interface::DebugData> debugData = model::debug_interface::DebugData::readFrom(stream);
