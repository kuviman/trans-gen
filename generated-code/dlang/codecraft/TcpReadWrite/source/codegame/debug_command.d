module codegame.debug_command;

import stream;
import std.conv;
import std.typecons : Nullable;
import model.debug_interface.debug_data;
...
abstract class DebugCommand {
    ...
    static class Add : DebugCommand {
        ...
        /// Data to add
        model.debug_interface.DebugData debugData;
    
        this() {}
    
        this(model.debug_interface.DebugData debugData) {
        ...
        static Add readFrom(Stream reader) {
            model.debug_interface.DebugData debugData;
            debugData = model.debug_interface.DebugData.readFrom(reader);
